...
### 音视频合并功能
- 🎵 **音频合并**：批量合并多个音频文件（MP3、WAV、OGG、FLAC、AAC、M4A）
- 🎬 **视频合并**：批量合并多个视频文件（MP4、AVI、MOV、MKV、TS、FLV）
- 🖱️ **拖拽排序**：支持拖拽文件添加，并自由调整合并顺序
- ⚡ **智能合并**：自动选择最佳合并策略，快速且无损
- 📊 **实时日志**：显示处理进度和状态
- 📁 **自动打开**：合并完成后自动打开输出目录

详细文档：
- [音视频合并功能说明.md](./音视频合并功能说明.md) - 完整功能说明和开发指南
- [音视频合并功能快速开始.md](./音视频合并功能快速开始.md) - 快速使用指南

## 更新日志

- **（v2.1.0）音视频合并功能** 🆕 新增音视频合并功能，支持批量合并音频和视频文件，拖拽排序，智能合并策略。
- **（v1.1.0）视频文件支持🎥**：支持直接导入视频文件，自动转换为音频进行处理，无需手动转换。
